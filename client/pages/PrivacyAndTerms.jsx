...
export default function Mail({navigation}) {
  return(
    <View style={styles.container}>
        ...
        אנו ב-IBD's מכבדים את פרטיות המשתמשים שלנו ומחויבים להגן על המידע האישי שאתם משתפים איתנו. כמו כן, אנו מבקשים מכל המשתמשים לעמוד בתנאי השימוש באפליקציה שלנו. להלן פירוט מדיניות הפרטיות ותנאי השימוש שלנו:
        {"\n"}{"\n"}
        ...
        {"\n"}{"\n"}{"\n"}{"\n"}
        <Text style={styles.bold}>יצירת קשר{"\n"}{"\n"}</Text>
        במידה ויש לכם שאלות בנוגע למדיניות הפרטיות ולתנאי השימוש שלנו, ניתן ליצור קשר דרך האפליקציה.
        </Text>
        </ScrollView>
